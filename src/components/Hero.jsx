      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <motion.div
              initial={{ y: 100, scale: 0.5,x:100 }}
              whileInView={{ y: 0, scale: 1, x:0 }}
            ...
            >
              ...
              <p className="mt-2 font-Amaranth text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl">
                Build your <span className="text-[#308a7b]">Dream</span> body
                with Nutrify
              </p>
              ...
              <div className=" mt-12 relative z-[0]">
                <button
                  ...
                  className="z-[1] hover:bg-[#5fb8a9] relative px-6 py-4 text-lg bg-[#308a7b] text-white rounded-md"
                >
                  Start Tracking
                </button>
                <img
