              ...
              <div className="home__left">
                <div>
                  <h1 className="home__title">
                    Build your healthy dream body today
                  </h1>
                  <img
                    className="underline__accent"
                    src={underlineAccent}
                    alt=""
                  />
                </div>
                <p className="home__description">
                  Acheive your dream physique and see progress like you never
                  have before. We’ll help you every step of the way to get
                  there.
                </p>
                <div className="home__buttons">
                  <button
                    onClick={() => navigate("/temp")}
                    className="home__button button__green"
                  >
                    Download the app
                  </button>
                  <button className="home__button button__clear">
                    Create an account
                  </button>
                  <img
                    src={buttonAccent}
                    alt=""
                    className="button__accent left__accent"
                  />
                  <img
                    src={buttonAccent}
                    alt=""
                    className="button__accent right__accent"
                  />
                </div>
              </div>
              <figure className="home__right">
                <img src={Flower} alt="" className="hero__flower " />
              </figure>
            </div>
          ...
          <div className="row">
            <div className="step__wrapper">
              <div className="one__left">
                ...
                <h2 className="step__title">Log from over 10 million foods</h2>
                <img src={one} alt="" className="one" />
                <p className="section__para step__para">
          ...
          <div className="row">
            <div className="step__wrapper step__two">
              ...
              <div className="one__left">
                ...
                <h2 className="step__title">Check day by day progress</h2>
                <img src={two} alt="" className="one two" />
                <p className="section__para step__para two__para">
                  Every single day is catalogged and is available to look at,
                  and see the progress you make overtime.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="step__wrapper step__three">
              <div className="one__left">
                ...
                <h2 className="step__title">Set desired goals with tips</h2>
                <img src={three} alt="" className="one three" />
                <p className="section__para step__para">
                  Whether it be your calories, weight, proteins, carbohydrates,
                  or fats goal, you can set it with our suggestion to help keep
                  you on track.
                </p>
              </div>
              <img
                src={threepicture}
                alt=""
                className="one__right three__picture"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="testimonials__wrapper">
              <h3 className="section__title test__section--title">
                You're not alone
              </h3>
              <h2 className="step__title test__title">
                See what others have to say
              </h2>
              <div className="test__card">
                <div className="test__card--left">
                  <p className="section__para test__para">
                    Whether it be your calories, weight, protein, or carbs,
                  ...
                  <div className="test__left--middle">
                    ...
                    <div className="name__title">
                      <div className="test__name">Tim Duncan</div>
                      <div className="test__name__title">
                        Bodybuilder Success
                      </div>
                    </div>
                  </div>
                  <div className="test__left--buttons">
                    <button className="test__left--button test__button">
                      {" "}
                      <FontAwesomeIcon
                        icon={faArrowLeft}
                        className="arrow"
                    ...
                    <button className="test__right--button test__button">
                      {" "}
                      <FontAwesomeIcon
                        icon={faArrowRight}
                        className="arrow"
